...
from app_config import has_gemini_api_key, load_app_config, save_app_config, get_default_location
from actions.weather import get_weather_summary

BASE_DIR = Path(__file__).resolve().parent

SYSTEM_NAME = "LEO"
MODEL_BADGE = "LEO VOICE CORE · macOS"
...
class JarvisUI:
    ...
    def _toggle_pause(self):
        ...
        if self.paused:
            ...
            self.write_log("SYS: LEO duraklatıldı.")
        else:
            self.set_state("THINKING")
            self.write_log("SYS: LEO devam ediyor...")
        self._sync_sound_state()
    ...
    def _shutdown(self):
        self.sound.stop_all()
        self.write_log("SYS: LEO kapatılıyor...")
    ...
    def _on_input_submit(self, event=None):
        ...
        if not text:
            return
        if self.paused:
            self.write_log("SYS: LEO duraklatılmış durumda. Devam etmek için pause'u kapat.")
            return
        self._input_var.set("")
    ...
    def _start_typing(self):
        ...
        elif tl.startswith("leo:") or tl.startswith("jarvis:") or tl.startswith("ai:"): tag = "ai"
    ...
    def _draw(self):
        ...
        c.create_text(W//2, 52, text="Personal AI Assistant · macOS",
        ...
        c.create_text(W//2, H-13, fill=C_DIM, font=font_body(9),
                      text="LEO · macOS Edition · Realtime Voice Core")
    ...
    def _save_api_key(self):
        ...
        if was_ready:
            ...
            self.set_state("LISTENING")
            self.write_log("SYS: LEO hazır. Dinliyorum...")
